...
class ZCU104MIGIODDR(depth : BigInt) extends GenericParameterizedBundle(depth) {
  require((depth<=0x80000000L),"ZCU104MIGIODDR supports upto 2GB depth configuraton") //200000000 //0x80000000L
...
{
  require((depth<=0x80000000L),"zcu104mig supports upto 2GB depth configuraton") //200000000 //0x80000000L

  val io = new ZCU104MIGIODDR(depth) with ZCU104MIGIOClocksReset {
