...
class ZCU104FPGATestHarness(override implicit val p: Parameters) extends ZCU104ShellBasicOverlays {
  ...
  val sys_clock2 = Overlay(ClockInputOverlayKey, new SysClock2ZCU104ShellPlacer(this, ClockInputShellInput()))
  val ddr2       = Overlay(DDROverlayKey, new DDR2ZCU104ShellPlacer(this, DDRShellInput()))
...
// DOC include start: ClockOverlay
  ...
  println(s"ZCU104 FPGA Base Clock Freq: ${dp(DefaultClockFrequencyKey)} MHz")
...
class ZCU104FPGATestHarnessImp(_outer: ZCU104FPGATestHarness) extends LazyRawModuleImp(_outer) with HasHarnessSignalReferences {
