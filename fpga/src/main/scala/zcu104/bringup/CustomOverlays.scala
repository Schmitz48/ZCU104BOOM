...
import chipyard.fpga.zcu104.{FMCPMap}

/* Connect the I2C to certain FMC pins */
class BringupI2CZCU104PlacedOverlay(val shell: ZCU104ShellBasicOverlays, name: String, val designInput: I2CDesignInput, val shellInput: I2CShellInput)
...
class BringupI2CZCU104ShellPlacer(val shell: ZCU104ShellBasicOverlays, val shellInput: I2CShellInput)(implicit val valName: ValName)
  extends I2CShellPlacer[ZCU104ShellBasicOverlays]
{
  def place(designInput: I2CDesignInput) = new BringupI2CZCU104PlacedOverlay(shell, valName.name, designInput, shellInput)
}

/* Connect the UART to certain FMC pins */
class BringupUARTZCU104PlacedOverlay(val shell: ZCU104ShellBasicOverlays, name: String, val designInput: UARTDesignInput, val shellInput: UARTShellInput)
...
class BringupUARTZCU104ShellPlacer(shell: ZCU104ShellBasicOverlays, val shellInput: UARTShellInput)(implicit val valName: ValName)
  extends UARTShellPlacer[ZCU104ShellBasicOverlays] {
  def place(designInput: UARTDesignInput) = new BringupUARTZCU104PlacedOverlay(shell, valName.name, designInput, shellInput)
}
...
class BringupGPIOZCU104PlacedOverlay(val shell: ZCU104ShellBasicOverlays, name: String, val designInput: GPIODesignInput, val shellInput: GPIOShellInput, gpioNames: Seq[String])
...
class BringupGPIOZCU104ShellPlacer(shell: ZCU104ShellBasicOverlays, val shellInput: GPIOShellInput, gpioNames: Seq[String])(implicit val valName: ValName)
  extends GPIOShellPlacer[ZCU104ShellBasicOverlays] {
  def place(designInput: GPIODesignInput) = new BringupGPIOZCU104PlacedOverlay(shell, valName.name, designInput, shellInput, gpioNames)
}
...
class BringupTSIHostZCU104PlacedOverlay(override val shell: BringupZCU104FPGATestHarness, override val name: String, override val designInput: TSIHostDesignInput, override val shellInput: TSIHostShellInput)
  extends TSIHostZCU104PlacedOverlay(shell, name, designInput, shellInput)
{
...
class BringupTSIHostZCU104ShellPlacer(shell: BringupZCU104FPGATestHarness, val shellInput: TSIHostShellInput)(implicit val valName: ValName)
  extends TSIHostShellPlacer[BringupZCU104FPGATestHarness] {
  def place(designInput: TSIHostDesignInput) = new BringupTSIHostZCU104PlacedOverlay(shell, valName.name, designInput, shellInput)
}
